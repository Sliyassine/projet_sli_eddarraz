...
def table(request):
    ...
    return render(request, 'temperature.html', {'valeurs': valeurs})
...
def chartHUM(request):
    ...
    s={'tab':tab}
    return render(request,'charthu.html',s)
...
def charttem(request):
    tab=Dht11.objects.all()
    s={'tab':tab}
    return render(request,'charttem.html',s)
...
def humidite(request):
    return render(request, 'humidite.html')

def charttemp(request):
    return render(request, 'charttem.html')

def charthu(request):
    return render(request, 'charthu.html')