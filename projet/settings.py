...
EMAIL_HOST_USER = 'sliyassine10@gmail.com' # remplacer avec votre adresse email
EMAIL_HOST_PASSWORD = 'bshg zrrf fsco iisj' # remplacer avec votre mot de passe email
